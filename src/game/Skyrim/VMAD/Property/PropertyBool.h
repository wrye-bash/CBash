...
public:
    ...
    PropertyBool & operator = (const PropertyBool &other);
};

class PropertyBoolArray : public Property, public std::vector<bool>
{
public:
    virtual uint32_t GetSize() const;
    virtual void Read(unsigned char *&buffer, const int16_t &version, const int16_t &objFormat, const bool &CompressedOnDisk);
    ...
    PropertyBoolArray & operator = (const PropertyBoolArray &other);
};

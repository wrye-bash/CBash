...
##        raise CBashError("Check the log.")
    ...
    try:
        _CGetVersionMajor = CBash.cb_GetVersionMajor
        _CGetVersionMinor = CBash.cb_GetVersionMinor
        _CGetVersionRevision = CBash.cb_GetVersionRevision
    except AttributeError: #Functions were renamed in v0.5.0
        _CGetVersionMajor = CBash.cb_GetMajor
        _CGetVersionMinor = CBash.cb_GetMinor
        _CGetVersionRevision = CBash.cb_GetRevision
    ...
    _CCreateCollection = CBash.cb_CreateCollection
    _CCreateCollection.errcheck = ZeroIsErrorCheck
    _CDeleteCollection = CBash.cb_DeleteCollection
    _CDeleteCollection.errcheck = NegativeIsErrorCheck
    _CLoadCollection = CBash.cb_LoadCollection
    _CLoadCollection.errcheck = NegativeIsErrorCheck
    _CUnloadCollection = CBash.cb_UnloadCollection
    _CUnloadCollection.errcheck = NegativeIsErrorCheck
    _CGetCollectionType = CBash.cb_GetCollectionType
    _CGetCollectionType.errcheck = NegativeIsErrorCheck
    _CUnloadAllCollections = CBash.cb_UnloadAllCollections
    _CUnloadAllCollections.errcheck = NegativeIsErrorCheck
    _CDeleteAllCollections = CBash.cb_DeleteAllCollections
    _CDeleteAllCollections.errcheck = NegativeIsErrorCheck
    _CAddMod = CBash.cb_AddMod
    _CAddMod.errcheck = ZeroIsErrorCheck
    _CLoadMod = CBash.cb_LoadMod
    _CLoadMod.errcheck = NegativeIsErrorCheck
    _CUnloadMod = CBash.cb_UnloadMod
    _CUnloadMod.errcheck = NegativeIsErrorCheck
    _CCleanModMasters = CBash.cb_CleanModMasters
    _CCleanModMasters.errcheck = NegativeIsErrorCheck
    _CSaveMod = CBash.cb_SaveMod
    _CSaveMod.errcheck = NegativeIsErrorCheck
    _CGetAllNumMods = CBash.cb_GetAllNumMods
    _CGetAllModIDs = CBash.cb_GetAllModIDs
    _CGetLoadOrderNumMods = CBash.cb_GetLoadOrderNumMods
    _CGetLoadOrderModIDs = CBash.cb_GetLoadOrderModIDs
    _CGetFileNameByID = CBash.cb_GetFileNameByID
    _CGetFileNameByLoadOrder = CBash.cb_GetFileNameByLoadOrder
    _CGetModNameByID = CBash.cb_GetModNameByID
    _CGetModNameByLoadOrder = CBash.cb_GetModNameByLoadOrder
    _CGetModIDByName = CBash.cb_GetModIDByName
    _CGetModIDByLoadOrder = CBash.cb_GetModIDByLoadOrder
    _CGetModLoadOrderByName = CBash.cb_GetModLoadOrderByName
    _CGetModLoadOrderByID = CBash.cb_GetModLoadOrderByID
    _CGetModIDByRecordID = CBash.cb_GetModIDByRecordID
    _CGetCollectionIDByRecordID = CBash.cb_GetCollectionIDByRecordID
    _CGetCollectionIDByModID = CBash.cb_GetCollectionIDByModID
    _CIsModEmpty = CBash.cb_IsModEmpty
    _CGetModNumTypes = CBash.cb_GetModNumTypes
    _CGetModNumTypes.errcheck = NegativeIsErrorCheck
    _CGetModTypes = CBash.cb_GetModTypes
    _CGetModTypes.errcheck = NegativeIsErrorCheck
    _CGetModNumEmptyGRUPs = CBash.cb_GetModNumEmptyGRUPs
    _CGetModNumEmptyGRUPs.errcheck = NegativeIsErrorCheck
    _CGetModNumOrphans = CBash.cb_GetModNumOrphans
    _CGetModNumOrphans.errcheck = NegativeIsErrorCheck
    _CGetModOrphansFormIDs = CBash.cb_GetModOrphansFormIDs
    _CGetModOrphansFormIDs.errcheck = NegativeIsErrorCheck

    _CGetLongIDName = CBash.cb_GetLongIDName
    _CMakeShortFormID = CBash.cb_MakeShortFormID
    _CCreateRecord = CBash.cb_CreateRecord
    _CCopyRecord = CBash.cb_CopyRecord
    _CUnloadRecord = CBash.cb_UnloadRecord
    _CResetRecord = CBash.cb_ResetRecord
    _CDeleteRecord = CBash.cb_DeleteRecord
    _CGetRecordID = CBash.cb_GetRecordID
    _CGetNumRecords = CBash.cb_GetNumRecords
    _CGetRecordIDs = CBash.cb_GetRecordIDs
    _CIsRecordWinning = CBash.cb_IsRecordWinning
    _CGetNumRecordConflicts = CBash.cb_GetNumRecordConflicts
    _CGetRecordConflicts = CBash.cb_GetRecordConflicts
    _CGetRecordHistory = CBash.cb_GetRecordHistory
    _CGetNumIdenticalToMasterRecords = CBash.cb_GetNumIdenticalToMasterRecords
    _CGetIdenticalToMasterRecords = CBash.cb_GetIdenticalToMasterRecords
    _CIsRecordFormIDsInvalid = CBash.cb_IsRecordFormIDsInvalid
    _CUpdateReferences = CBash.cb_UpdateReferences
    _CGetRecordUpdatedReferences = CBash.cb_GetRecordUpdatedReferences
    _CSetIDFields = CBash.cb_SetIDFields
    _CSetField = CBash.cb_SetField
    _CDeleteField = CBash.cb_DeleteField
    _CGetFieldAttribute = CBash.cb_GetFieldAttribute
    _CGetField = CBash.cb_GetField
    ...
    CBash.cb_RedirectMessages(LoggingCallback)
    CBash.cb_AllowRaising(RaiseCallback)
...
##        fIsSkipAllRecords        = 0x00002000
    ...
    def load(self):
        def progressCallback(current, last, modName):
            return True

        progressCb = CFUNCTYPE(c_bool, c_uint32, c_uint32, c_char_p)(progressCallback)
        _CLoadCollection(self._CollectionID, progressCb)
